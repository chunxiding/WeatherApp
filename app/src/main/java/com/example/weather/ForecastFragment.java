...
public class ForecastFragment extends Fragment {
        ...
        compositeDisposable.add(mService.getWeatherForecastByLatLng(String.valueOf(Common.current_location.getLatitude()),
                ...
                .subscribe(new Consumer<WeatherForecastResults>() {
                    ...
                    public void accept(WeatherForecastResults weatherForecastResults) throws Exception {
                        displayForecastWeather(weatherForecastResults);
                    }
    ...
    private void displayForecastWeather(WeatherForecastResults weatherForecastResults) {
        txt_city_name.setText(new StringBuilder(weatherForecastResults.city.name));
        txt_geo_coord.setText(new StringBuilder(weatherForecastResults.city.coord.toString()));
